...
class UserAds extends Apartment {
	...
	public static function returnStatusHtml($data, $tableId, $onclick = 0, $ignore = 0, $returnName = false){
	...
	public static function returnStatusOwnerActiveHtml($data, $tableId, $onclick = 0, $ignore = 0, $returnName = false){
		if($ignore && $data->id == $ignore){
			return '';
		}
