<?php
	...
	Yii::app()->clientScript->registerCssFile(Yii::app()->request->baseUrl.'/common/js/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css');
	Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl.'/css/ui/jquery-ui-1.8.16.custom.css');

	Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/common/js/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js', CClientScript::POS_HEAD);
...
<div class="form">
	...
	<?php $form=$this->beginWidget('CustomForm', array(
		...
		'htmlOptions'=>array('class'=>'well form-disable-button-after-submit', 'enctype'=>'multipart/form-data'),
	)); ?>
		...
		<div id="watermarkTextSettings">
            ...
            <div class="form-group">
                ...
                <div class="input-append color" data-color="<?php echo $model->watermarkTextColor; ?>" data-color-format="rgb" id="watermarkTextColor">
                    <input id="ImageSettings_watermarkTextColor" type="text" class="span2 inline" value="<?php echo $model->watermarkTextColor; ?>" name="ImageSettings[watermarkTextColor]" />
                    <span class="add-on inline"><i style="background-color: <?php echo $model->watermarkTextColor; ?>;"></i></span>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-append">
					<?php echo $form->textField($model, 'watermarkTextOpacity', array('class' => 'span1 inline')); ?>
                    <span class="add-on inline">%</span>
                </div>
