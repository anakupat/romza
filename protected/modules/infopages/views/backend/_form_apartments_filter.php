<div id="apartments_filter" style="display: none;" class="well">
	...
	if(issetModule('location')){ ?>
		<div class="">
			...
			echo CHtml::dropDownList(
				...
				array('class' => 'searchField form-control', 'id' => 'country',
					'ajax' => array(
						'type'=>'GET',
		...
		<div class="">
			...
			echo CHtml::dropDownList(
				...
				array('class' => 'searchField form-control', 'id' => 'region',
					'ajax' => array(
						'type'=>'GET',
	...
	$typeList = HApartment::getTypesForSearch(true);
		...
		<div class="" id="metro-block" style="display: block; <?php /* echo ($metros && count($metros) > 1) ? 'block;' : 'none;'; */?>">
			...
			<?php
				echo Chosen::multiSelect('filter[metro][]', $this->getFilterValue('metro'), $metros,
					array('id'=>'metro', 'class' => ' searchField span3 form-control', 'data-placeholder' => tt('Select metro stations', 'metroStations'))
				);
	...
	<?php else:?>
		<div class="">
			...
			echo CHtml::dropDownList(
				...
				$this->getFilterValue('city_id'),
				$cities,
				array('class' => ' searchField form-control', 'id' => 'ap_city') //, 'multiple' => 'multiple'
			);
			?>
		</div>
	<?php endif;?>
