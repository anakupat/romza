...
<body class="skin-blue sidebar-mini">
	<div class="wrapper">
				...
				echo BsHtml::sidemenu('',array(
					...
					array('label' => tc('Settings'), 'icon' => 'wrench', 'visible' => Yii::app()->user->checkAccess('all_settings_admin'), 'items'=>
						array(
							...
							array('label' => tc('Change admin password'), 'icon' => 'wrench', 'url' => $baseUrl . '/adminpass/backend/main/index', 'active' => isActive('adminpass'), 'visible' => Yii::app()->user->checkAccess('all_settings_admin')),
					...
					array('label' => tc('Modules'), 'icon' => 'th', 'visible' => Yii::app()->user->checkAccess('all_modules_admin') && (issetModule('notifier') || issetModule('slider') || issetModule('advertising') || issetModule('iecsv') || issetModule('formdesigner') || issetModule('socialposting')), 'items'=>
						array(
					...
					array('label' => tc('Location module'), 'icon' => 'map-marker', 'notify'=>$bageCities, 'visible' => (issetModule('location') && Yii::app()->user->checkAccess('all_reference_admin')), 'items'=>
						array(
		...
		$cs->registerScriptFile($baseThemeUrl . '/js/adminCommon.js', CClientScript::POS_HEAD);
		...
		$cs->registerScriptFile($baseUrl.'/common/js/bootstrap.'.$min.'js', CClientScript::POS_HEAD);
		$cs->registerScriptFile($baseUrl.'/common/js/app.'.$min.'js', CClientScript::POS_HEAD);
